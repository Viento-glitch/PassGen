...
//            System.out.println(new String(key,"UTF-8"));
    ...
    public static String execute(String strToEncrypt) {
        try {
...
//        System.out.println("String to Encrypt: " + strToEncrypt);
        ...
        AES.AESdecrypt(strToDecrypt.trim());

//        System.out.println("String To Decrypt : " + strToDecrypt);

//        System.out.println("Сайт : " + AES.getDecryptedString());
//        System.out.println("Пароль : " + AES.getEncryptedString());
